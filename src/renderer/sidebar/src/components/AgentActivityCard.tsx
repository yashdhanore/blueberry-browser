                    ...
                    <div className="mt-2">
                        ...
                        <div className="rounded-lg border border-border overflow-hidden">
                            {screenshot ? (
                                ...
                                <div className="flex flex-col items-center justify-center p-6 text-xs text-muted-foreground bg-background/60">
                                    <span>No screenshot yet</span>
                                    {isRunning && (
                                        <span className="mt-1 text-[11px] text-muted-foreground/80">Agent is preparing a view...</span>
                                    )}
                                </div>
                            )}
                        </div>
                    ...
                    <>
                        ...
                        {!isRunning && finalResponse && (
                            <div className="mb-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                                <div className="text-xs font-medium text-green-600 dark:text-green-400 mb-1.5">✓ Completed</div>
                                ...
                                {actions.length > 0 && (
                                    <p className="text-xs text-green-600/60 dark:text-green-400/60 mt-1.5">
                                        Completed {actions.length} action{actions.length !== 1 ? 's' : ''} in {currentTurn} turn
                                        {currentTurn !== 1 ? 's' : ''}
                                    </p>
                                )}
                            </div>
                        ...
                        {!isRunning && error && (
                            <div className="mb-3 p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                                <div className="text-xs font-medium text-red-600 dark:text-red-400 mb-1.5">Error</div>
